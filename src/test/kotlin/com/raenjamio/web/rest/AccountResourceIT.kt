...
import com.raenjamio.config.DEFAULT_LANGUAGE
import com.raenjamio.domain.Authority
import com.raenjamio.domain.PersistentToken
import com.raenjamio.domain.User
import com.raenjamio.repository.AuthorityRepository
import com.raenjamio.repository.PersistentTokenRepository
import com.raenjamio.repository.UserRepository
import com.raenjamio.security.ADMIN
import com.raenjamio.security.USER
import com.raenjamio.service.MailService
import com.raenjamio.service.UserService
import com.raenjamio.service.dto.PasswordChangeDTO
import com.raenjamio.service.dto.UserDTO
import com.raenjamio.web.rest.errors.ExceptionTranslator
import com.raenjamio.web.rest.vm.KeyAndPasswordVM
import com.raenjamio.web.rest.vm.ManagedUserVM
...
class AccountResourceIT {
    ...
    fun setup() {
        ...
        val accountResource = AccountResource(userRepository, userService, mockMailService, persistentTokenRepository)

        val accountUserMockResource =
            AccountResource(userRepository, mockUserService, mockMailService, persistentTokenRepository)
